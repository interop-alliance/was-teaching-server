...
describe('Collections API', () => {
  ...
  beforeAll(async () => {
    ...
    // Provision the Space this suite operates on. The 'data/' directory is
    // gitignored, so it must be created here rather than relying on filesystem
    // state left behind by other test files.
